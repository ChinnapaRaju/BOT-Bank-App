...
<body>
		...
		<nav class="navbar">
			...
			<div class="profile-dropdown">
				...
				<ul class="profile-dropdown-list">
					...
					<li class="profile-dropdown-list-item"><a href="downloadthistory"> <i
							class="fa-solid fa-chart-line"></i> Transcation History
					</a></li>
					...
					<li class="profile-dropdown-list-item"><a href="welcomepage"> <i
	...
	<div id="story">
		...
		<h2 class="heading" ><i><b>BOT Internet Bank</b></i></h2>
		<br>
		<div class="row">
			<div class="boxes">
